...
@Component({
  selector: 'page-admin-client-restaurant-owner-activation',
  templateUrl: 'admin-client-restaurant-owner-activation.html',
})
export class AdminClientRestaurantOwnerActivationPage {
